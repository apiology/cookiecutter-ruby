...
Fix from the **CI error message**, push, `gh pr checks --watch`. For baked Ruby gems, read the nested **`typecheck-rbi-and-ci`** skill when CI and local Solargraph/Sorbet disagree.
